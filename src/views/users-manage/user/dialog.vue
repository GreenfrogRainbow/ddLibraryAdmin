		...
		<el-dialog :title="state.dialog.title" v-model="state.dialog.isShowDialog" width="769px">
			<el-form ref="userDialogFormRef" :model="state.ruleForm" size="default" label-width="90px">
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="职业">
							<el-cascader
								...
								clearable
								class="w100"
								v-model="state.ruleForm.profession"
							>
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="账户生日">
							<el-date-picker v-model="state.ruleForm.birth" type="date" placeholder="请选择" class="w100"> </el-date-picker>
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
...
const onSubmit = async () => {
	await request.post('/api/regUserDetail', state.value.ruleForm )
	closeDialog();
	emit('refresh');
};
// 初始化部门数据
const getMenuData = () => {
	state.value.deptData.push(
				{
					deptName: '技术开发',
					value: '技术开发'
				},
