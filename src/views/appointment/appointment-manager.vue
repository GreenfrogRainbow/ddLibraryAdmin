...
<script setup name="allappointment">
import { defineAsyncComponent, onMounted, ref } from 'vue';
import { ElMessageBox, ElMessage } from 'element-plus';
import request from '/@/utils/request'

// 引入组件
const UserDialog = defineAsyncComponent(() => import('/src/views/appointment/dialog.vue'));
...
const getTableData = async () => {
	...
	const res = await request.get('/userinfo/getAllUserInfo')
	state.value.tableData.data = res.data;
	// eslint-disable-next-line no-console
	state.value.tableData.total = state.value.tableData.data.length;
